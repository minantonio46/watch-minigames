...
- **순환형 카드 캐러셀 & 모션**: 화면 가운데 현재 선택된 카드가 크게 표시되고 양옆에 이전/다음 카드가 미리보기 형태로 배치됩니다. 끝에 도달하면 멈추지 않고 순환(무한 루프) 형식으로 계속 돌 수 있습니다. 좌우 실시간 드래그 반응, 부드러운 스냅 전환 애니메이션(`slide-in`), 터치 피드백, 즐겨찾기 팝 애니메이션 등 워치 화면에 최적화된 가볍고 자연스러운 모션이 적용되어 있습니다.
